...
third_party_datas = []
for pkg in ('faster_whisper', 'ctranslate2', 'huggingface_hub', 'ffpyplayer', 'pyautogui', 'certifi', 'requests'):
...
a = Analysis(
    ...
    binaries=binaries,
    datas=datas,
    hiddenimports=['ffpyplayer.player', 'pyaudio', 'pyautogui', 'pynput', 'requests'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=['astroid', 'bs4'],
    noarchive=False,
)
