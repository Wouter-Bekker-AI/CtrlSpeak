...
DEFAULT_SETTINGS: Dict[str, object] = {
    ...
    "gpu_cleanup_enabled": False,
    "gpu_cleanup_preserve_formatting": False,
...
_SETTING_VALIDATORS: Dict[str, Callable[[object], bool]] = {
    ...
    "gpu_cleanup_enabled": lambda value: isinstance(value, bool),
    "gpu_cleanup_preserve_formatting": lambda value: isinstance(value, bool),
